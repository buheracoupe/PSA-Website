    ...
    <header className="site-header">
      <div className="container header-inner">
        <Link to="/" className="brand brand-lockup" aria-label="Pump Systems Africa home">
          <span className="brand-emblem"><img src="/brand/psa-logo.png" alt="" /></span>
          <span className="brand-name"><strong>Pump Systems</strong><strong>Africa</strong></span>
        </Link>
      ...
      {open && (
        <nav className="mobile-nav" aria-label="Mobile navigation">
          <div className="container mobile-nav-inner">
            ...
            <Link className="button button-primary" to="/contact" onClick={() => setOpen(false)}>Get a Quote</Link>
          </div>
        </nav>
      )}
    </header>
