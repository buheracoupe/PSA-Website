...
export function AboutPage() {
  return <div className="company-page"><PageTitle title="About" />
    ...
    <section className="container company-sectors" id="applications" style={{ scrollMarginTop: 100 }}><span className="company-eyebrow">Applications</span><h2>Where water and industry meet.</h2><div>{['Agriculture & irrigation', 'Mining & processing', 'Water & wastewater', 'Food & beverage', 'Chemical & pharmaceutical', 'Construction', 'Petrochemical', 'Pulp & paper'].map(name => <span key={name}>{name}</span>)}</div></section>
    <ContactBand />
  </div>
}
...
export function ServicesPage() {
  return <div className="company-page"><PageTitle title="Services" />
    ...
    <section className="container company-story company-service-story"><div className="company-story-copy"><span className="company-eyebrow">Support close to the application</span><h2>From the workshop<br />to the field.</h2><p>Our Harare workshop is backed by installation and commissioning experience across pump stations, treatment plants and irrigation infrastructure.</p><p>Whether the requirement is to refurbish a pump or bring a water system into service, PSA connects equipment knowledge with hands-on delivery.</p><Link to="/projects#water-projects" className="company-text-link">See our work in the field <ArrowRight size={17} /></Link></div><div className="company-story-image"><img src="/contact/psa-workshop.webp" alt="PSA workshop technician servicing a blue KSB pump" width="1600" height="1067" loading="lazy" /></div></section>
